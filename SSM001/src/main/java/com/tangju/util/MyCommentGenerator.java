...
/**
 * mybatis generator 自定义comment生成器. 基于MBG 1.3.5.
 * 
 * @author tangju 2017-07-24
 *
 */
public class MyCommentGenerator implements CommentGenerator {
    ...
    /**
	 * 应用generatorConfig.xml中的配置:commentGenerator标签
	 * 
	 * @see
	...
	public void addClassComment(InnerClass innerClass, IntrospectedTable introspectedTable) {
		...
		innerClass.addJavaDocLine("自定义注释1"); //$NON-NLS-1$
...
//		sb.append(" * This class corresponds to the database table "); //$NON-NLS-1$
	...
	public void addModelClassComment(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
		...
		topLevelClass.addJavaDocLine(" * Create at "+sdf.format(new Date()));
...
//
//		field.addJavaDocLine("/**"); //$NON-NLS-1$
//		field.addJavaDocLine(" * 自定义注释AAAA002"); //$NON-NLS-1$
//
...
//		method.addJavaDocLine(" * 自定义注释BBB001"); //$NON-NLS-1$
//
...
//		xmlElement.addElement(new TextElement("-->")); //$NON-NLS-1$
	...
	public void addClassComment(InnerClass innerClass, IntrospectedTable introspectedTable, boolean markAsDoNotDelete) {
		...
		innerClass.addJavaDocLine("/**"); //$NON-NLS-1$
		innerClass.addJavaDocLine("自定义注释3"); //$NON-NLS-1$
